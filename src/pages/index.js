...
const IndexPage = () => (
  <Layout>
    <SEO title="Home" />
    <div className="text-center center text-white text-3xl lg:text-5xl grid md:flex items-center w-full h-screen relative z-0">
      <img
        src={pc}
        alt="a laptop partially opened"
        className="opacity-50 md:opacity-100 w-full md:w-1/2 h-screen md:h-screen object-cover object-right"
      />
      <div className="absolute md:relative text-shadow grid justify-center p-5 w-full md:w-1/2">
        <h1 className="text-3xl lg:text-5xl">Gatsby Developer</h1>
        <p>Wowsers!</p>
